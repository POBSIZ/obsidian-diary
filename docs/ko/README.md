...
Diary는 Obsidian vault 안의 Markdown 파일을 날짜 기반 플래너로 보여주는 커뮤니티 플러그인입니다. 연간 개요, 월간 그리드, 월간 목록을 오가며 단일 날짜 노트, 기간 노트, 월/연 플랜 노트, 캘린더 오버레이 라벨 하나, 사용자가 추가한 외부 캘린더 오버레이, 공휴일, todo 상태, 로컬 알림을 한 곳에서 관리할 수 있습니다.
...
- 외부 일정을 선택하면 상세 모달에서 **Markdown 노트 만들기**, **캘린더 새로고침**, **상세 복사**를 실행할 수 있습니다.
